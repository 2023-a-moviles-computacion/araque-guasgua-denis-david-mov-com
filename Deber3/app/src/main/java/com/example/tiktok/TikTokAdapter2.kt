...
class TikTokAdapter2(private val dataList: List<TikTokItemModel>) : RecyclerView.Adapter<TikTokAdapter2.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        //private val discoImageView: ImageView = itemView.findViewById(R.id.img_disco)
        ...
        fun bind(item: TikTokItemModel) {
            //discoImageView.setImageResource(item.discoResId)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_tiktok2, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.bind(item)
        // Cargar el GIF animado en el ImageView correspondiente
